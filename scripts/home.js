...
document.getElementById("lang-hi").addEventListener("click", function () {
  setTimeout(displayTextContent("Hindi"), 2000);
  document.querySelector(".language").textContent = "HI";
});

document.getElementById("lang-zh").addEventListener("click", function () {
  setTimeout(displayTextContent("Chinese"), 2000);
  document.querySelector(".language").textContent = "ZH";
});

document.getElementById("lang-en").addEventListener("click", function () {
  setTimeout(displayTextContent("English"), 2000);
...
function checkScreenWidth() {
  ...
  if (screenWidth < 700) {
    ...
    document.querySelector(".channeldiv").style.gridTemplateColumns =
      "repeat(2, 1fr)";

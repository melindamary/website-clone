...
define(["require", "exports", "./config"], function (require, exports, config_1) {
    ...
    if (hamburgerElement) {
        hamburgerElement.onclick = function () {
            ...
            menu === null || menu === void 0 ? void 0 : menu.classList.toggle("show");
        };
    }
    //carousel
    function fetchMovies() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield fetch(config_1.url);
                if (!response.ok) {
    ...
    function populateCarousel(movies) {
        ...
        movies.forEach((movie, index) => {
            if (index < 10) {
                ...
                const carouselItemImage = carouselItem.querySelector(".carousel-image");
                if (!carouselItemImage)
                    return;
                carouselItemImage.src = `${config_1.imageBaseUrl}${movie.backdrop_path}`;
                carouselItemImage.alt = movie.title;
                const carouselItemMovieTitle = carouselItem.querySelector(".movie-carousel-name");
                if (!carouselItemMovieTitle)
                    return;
    ...
    function fetchTrailer(movieId) {
        return __awaiter(this, void 0, void 0, function* () {
            const videosUrl = `https://api.themoviedb.org/3/movie/${movieId}/videos?api_key=${config_1.apiKey}&adult=false`;
            try {
                const response = yield fetch(videosUrl);
                if (!response.ok) {
                    throw new Error(`HTTP error! status: ${response.status}`);
                }
                const data = (yield response.json()); //toDo
    ...
    function setupCarousel(movie, carouselItem) {
        return __awaiter(this, void 0, void 0, function* () {
            const videoElement = carouselItem.querySelector(".carousel-video");
            const trailerUrl = yield fetchTrailer(movie.id);
            if (!videoElement)
                return;
            carouselItem.style.backgroundImage = `url(${config_1.imageBaseUrl}${movie.backdrop_path})`;
            const carouselItemMovieTitle = carouselItem.querySelector(".movie-carousel-name");
            if (!carouselItemMovieTitle)
                return;
            carouselItemMovieTitle.textContent = movie.title;
    ...
    function fetchMoviesByGenre(...genreId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const url = `https://api.themoviedb.org/3/discover/movie?api_key=${config_1.apiKey}&with_genres=${genresQuery}&adult="false"`;
            try {
    ...
    function fetchLatestMovies() {
        return __awaiter(this, void 0, void 0, function* () {
            const url = `https://api.themoviedb.org/3/discover/movie?api_key=${config_1.apiKey}&with_origin_country=IN&sort_by=popularity.desc&primary_release_year=2024&primary_release_date.lte=2024-05-29`;
            try {
                const response = yield fetch(url);
                const data = yield response.json();
                return data.results;
    ...
    function fetchMoviesByLanguage(language) {
        return __awaiter(this, void 0, void 0, function* () {
            const url = `https://api.themoviedb.org/3/discover/movie?api_key=${config_1.apiKey}&with_original_language=${language}&adult="false"`;
            try {
                const response = yield fetch(url);
                const data = yield response.json();
                return data.results;
        ...
        <div id="top-10-carousel" class="carousel slide h-10 p-3 ml-3 mr-3 " data-ride="carousel">
            ...
            <div class="carousel-inner rounded" id="carousel-inner">
                <div style="height:25rem;">
                    <img class="carousel-image" src="${config_1.imageBaseUrl}${movie.backdrop_path}" alt="${movie.title}">
    ...
    function createMovieCard(flag, movie, id = 0) {
    ...
    function populateSection(containerId, flag, ...genreId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            let container = (_a = document
                .getElementById(containerId)) === null || _a === void 0 ? void 0 : _a.querySelector(".d-flex");
            if (!container)
                return;
            const movies = yield fetchMoviesByGenre(...genreId);
            container.innerHTML = "";
    ...
    function populateSectionLanguage(containerId, flag) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            if (!container)
                return;
            const movies = yield fetchMoviesByLanguage("en");
            container.innerHTML = "";
            movies.forEach((movie) => {
                const card = createMovieCard(flag, movie);
                container.appendChild(card);
    ...
    function populateSectionLatestMovies(containerId, flag) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const container = (_a = document
                .getElementById(containerId)) === null || _a === void 0 ? void 0 : _a.querySelector(".d-flex");
            if (!container)
                return;
            const movies = yield fetchLatestMovies();
            container.innerHTML = "";
            movies.forEach((movie) => {
                const card = createMovieCard(flag, movie);
                container.appendChild(card);
    ...
    function topIndianMovies(containerId, flag) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const container = (_a = document
                .getElementById(containerId)) === null || _a === void 0 ? void 0 : _a.querySelector(".d-flex");
    ...
    const sliderFunctionality = () => __awaiter(void 0, void 0, void 0, function* () {
        const slideContainer = document.querySelector(".slide-container");
        if (!slideContainer)
            return;
        const fetchMovies = () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${config_1.apiKey}`);
            const data = yield response.json();
            return data.results;
        });
        ...
        seeMoreLinks.forEach(function (link) {
            link.addEventListener("click", function (event) {
                ...
                if (link.getAttribute("data-genre-id")) {
                    genreIds = (_a = link.getAttribute("data-genre-id")) === null || _a === void 0 ? void 0 : _a.split(",");
                }
